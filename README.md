...
### Результаты отдельных сценариев
...
- `scenarios/*.svg` — визуализации отдельных сценариев.
...
src/ozon_dimension_demo/
  ...
  benchmark.py      серия сценариев и SVG-визуализации
...
benchmark_output/    результаты и визуализации сценариев
```
